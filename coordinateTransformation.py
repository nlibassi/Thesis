...
srcFile = ogr.Open('/home/nlibassi/Geodesy/Thesis/Project/Vector/WGS84/2001_2002_Benchmarks_TruncTable.shp')
srcLayer = srcFile.GetLayer(0)

#Create the dest shapefile and give it the new projection

dstLoc = '/home/nlibassi/Geodesy/Thesis/Project/Vector/ITRF96TM30/2001_2002_Benchmarks_TruncTable_ITRF'
dstShp = '2001_2002_Benchmarks_TruncTable_ITRF.shp'
